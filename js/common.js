$(function() {
    ...
    if ("" != YMaps.location.city) {
        var e = YMaps.location.city;
        $(".geo").prepend(e)
    }
    document.getElementById("city").value = e, $(".tb-tele, .in-tele, .mw-tele, .samples-tele, .know-price-tele, .cp-tele").mask("+7(999)999-99-99"), window.onscroll = function() {
            document.getElementById("toTop").style.display = "200" < window.pageYOffset ? "block" : "none"
            ...
            type: "inline",
            midClick: !0
        }), $(".pwimg-wrap").each(function(e) {
            $(this).find("a").attr("href", "#work_" + e), $(this).find(".modal-descr-pr").attr("id", "work_" + e)
